...
export default function Hero() {
    return (
        <section className="min-h-screen bg-accent-foreground text-accent relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 py-20 relative w-full  h-screen">
                <div className="h-full flex items-center relative">
                    ...
                    <div className="space-y-8 relative z-10">
                        <h1 className="text-5xl lg:text-6xl font-bold leading-tight text-title lg:max-w-4xl">
                            Deepen Your Islamic Knowledge Journey
                        </h1>

                        <p className="text-lg text-white leading-relaxed max-w-lg">
                            Learn authentic Islamic sciences from qualified scholars. Join a global community of Muslims seeking
                            knowledge through structured courses in Aqeedah, Fiqh, Tafsir, and more.
                        </p>
