...
export default function SignUpThirdPage() {
    ...
    const handleSubmit = async (formData: FieldValues) => {
        const registerData = {
            ...
            isReferredBySheikhSalmam: formData.isSheikhSalmanReferred === 'yes'? true : false,
            ...
            isTakeCourseWithSheikh: data.isTakeCourseWithSheikh  === 'yes'? true : false,
    ...
    return (
        ...
        >
            ...
            <Button disabled={isLoading} type="submit" className="w-full mt-6" size="lg" variant="secondary">
                Sign Up
            </Button>
        </CustomForm>
    );
